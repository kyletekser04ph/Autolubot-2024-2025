...
module.exports.run = async function ({ api, event, args }) {
    ...
    try {
        ...
        const responseMessage = `[🌐] - 𝗔𝗨𝗧𝗢𝗟𝗨𝗕𝗢𝗧 𝗥𝗘𝗦𝗣𝗢𝗡𝗦𝗘:\n\n▬▬▬▬▬▬▬▬▬▬▬▬\n👤 Question Asked by: ${userNames.join(', ')}\n▬▬▬▬▬▬▬▬▬▬▬▬\n𝗔𝗡𝗦𝗪𝗘𝗥💬: ${backupResult}\n▬▬▬▬▬▬▬▬▬▬▬▬\n𝙘𝙧𝙚𝙙𝙞𝙩𝙨: https://www.facebook.com/100052395031835\n\n𝗖𝗿𝗲𝗮𝘁𝗲 𝘆𝗼𝘂𝗿 𝗢𝘄𝗻 𝗕𝗼𝘁 𝗛𝗲𝗿𝗲: https://autolubot-psi-kyledev03.😲onrender.😲com\n\nRemove The Emoji.`;
